...
public class ConfigReader {
     ...
     */
    private <T> Optional<T> getCapability(String platform, String key, Function<JsonElement, T> converter) {
        try {
    ...
    public boolean isScreenshotOnFailure() {
        return getCapability(TEST_SETTINGS, SCREENSHOT_ON_FAILURE, JsonElement::getAsBoolean).orElse(true);
    }
}
